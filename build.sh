...
ISO1_EXEC='ExecStart=/usr/bin/cage -s -- /usr/bin/firefox --kiosk --profile "/home/live/.mozilla/firefox/m1j0kl8f.kiosk_profile" --no-remote --private --start-fullscreen --disable-popup-blocking --no-proxy-server --private-window "https://screen.bailriggfm.co.uk/view/office?pass=primary"'
ISO2_EXEC='ExecStart=/usr/bin/cage -s -- /usr/bin/firefox --kiosk --profile "/home/live/.mozilla/firefox/m1j0kl8f.kiosk_profile" --no-remote --private --start-fullscreen --disable-popup-blocking --no-proxy-server --private-window "https://screen.bailriggfm.co.uk/view/studio-a"'
